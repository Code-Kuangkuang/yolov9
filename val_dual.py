...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/voc2017.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'runs/train/exp-yolov9-eca-100epoch/weights/best.pt', help='model path(s)')
